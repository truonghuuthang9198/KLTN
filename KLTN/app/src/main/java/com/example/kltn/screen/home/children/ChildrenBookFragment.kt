...
import com.example.kltn.screen.home.bestbook.ChildBestBookFragment
...
class ChildrenBookFragment : Fragment() {
    ...
    private fun setStatePageAdapter(){
        ...
        myViewPageStateAdapter.addFragment(ChildBestBookFragment(0),"Sách Thiếu Nhi Giá Tốt")
        myViewPageStateAdapter.addFragment(ChildBestBookFragment(1),"Truyện Đọc Thiếu Nhi")
